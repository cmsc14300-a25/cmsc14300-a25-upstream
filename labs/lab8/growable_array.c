 ...
 * CMSC 14300
 * Autumn 2025
 * Lab 8: Extending the growable array interface.
 *
...
struct growable_array {
  ...
  element_fn_t free_fn;   // <== new field
  void **data;
};
...
garray_t *mk_garray(unsigned int initial_size, element_fn_t free_fn) {
  ...
  // TODO: update this function to save the second parameter in the
  // result.
...
void garray_free(garray_t *garray) {
  ...
  // TODO: update this function to use the free function
  // in the growable array structure to free the elements
  // if the stored function pointer is not NULL.
...
/* garray_print -- see growable_array.h for the header comment */
void garray_print(garray_t *garray, element_fn_t print_fn) {
  // TODO: complete this function
}


/* garray_foreach -- see growable_array.h for the header comment */
void garray_foreach(garray_t *garray, element_fn_t fn) {
  // TODO: complete this function
}


/* garray_foreach_with_data -- see growable_array.h for the header comment */
